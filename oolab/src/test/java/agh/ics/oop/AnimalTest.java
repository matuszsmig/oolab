...
class AnimalTest {
    ...
    void animalMovesProperly() {
        ...
        camel.move(MoveDirection.LEFT);
        camel.move(MoveDirection.BACKWARD);
        ...
        //then
        assertEquals(new Vector2d(3, 3), camel.getPosition());
        assertEquals(new Vector2d(4, 2), eagle.getPosition());
        assertEquals(new Vector2d(1, 1), elephant.getPosition());
    }
    ...
    void mapGotTheBorders(){
        ...
        //then
        assertTrue(camel.isAt(new Vector2d(2, 4)));
